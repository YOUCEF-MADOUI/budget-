...
data class AccountWithBalance(val id:String,val name:String,val type:String,val currencyCode:String,val initialBalanceMinor:Long,val currentBalanceMinor:Long,val isArchived:Boolean,val iconKey:String,val colorKey:String,val description:String,val displayOrder:Int,val parentAccountId:String?,val mediaId:String?)
