...
interface CategoryDao {
    ...
    @Query("UPDATE categories SET custom_name = :name, icon_key = :iconKey, color_key = :colorKey, updated_at = :now WHERE id = :id AND is_system = 0")
    ...
    @Query("UPDATE categories SET deleted_at = :now, updated_at = :now WHERE id = :id AND is_system = 0")
