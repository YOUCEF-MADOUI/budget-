...
class AndroidFeatureConventionPlugin : Plugin<Project> {
    override fun apply(target: Project) {
        ...
        dependencies.add("testImplementation", libs.findLibrary("androidx-test-runner").get())
        dependencies.add("testImplementation", libs.findLibrary("robolectric").get())
        dependencies.add("testImplementation", libs.findLibrary("androidx-compose-ui-test-manifest").get())
          }
    }
}
