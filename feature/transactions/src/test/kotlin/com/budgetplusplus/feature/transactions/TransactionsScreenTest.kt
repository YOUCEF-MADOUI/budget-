...
private class FakeTransactions:TransactionRepository{val values=MutableStateFlow<List<FinanceTransaction>>(emptyList());val saved=mutableListOf<SavedTransaction>();override fun observeTransactions():Flow<List<FinanceTransaction>> =values;override suspend fun get(id:String)=values.value.firstOrNull{it.id==id};override suspend fun create(type:TransactionType,amountMinor:Long,accountId:String,destinationAccountId:String?,categoryId:String?,description:String,subcategoryId:String?,currencyCode:String,localDate:String?){saved+=SavedTransaction(type,amountMinor,accountId,destinationAccountId,categoryId);values.value=listOf(FinanceTransaction("id",type,amountMinor,currencyCode,accountId,"Cash",categoryId=categoryId,categoryCustomName="Food",occurredAt=1))};override suspend fun update(id:String,type:TransactionType,amountMinor:Long,accountId:String,destinationAccountId:String?,categoryId:String?,description:String,subcategoryId:String?,localDate:String)=Unit;override suspend fun delete(id:String)=Unit}
private class FakeTransactionAccounts:AccountRepository{override fun observeAccounts()=flowOf(listOf(Account("cash","Cash",AccountType.CASH,"DZD",0,0),Account("bank","Bank",AccountType.BANK,"DZD",0,0)));override fun observeTotals(id:String)=flowOf(AccountOperationTotals());override suspend fun create(name:String,type:AccountType,initialBalanceMinor:Long,currencyCode:String)=Unit;override suspend fun update(id:String,name:String,type:AccountType,iconKey:String,colorKey:String,description:String,displayOrder:Int)=Unit;override suspend fun setArchived(id:String,archived:Boolean)=Unit;override suspend fun reassignOperations(sourceAccountId:String,targetAccountId:String,transactionIds:Set<String>)=Unit;override suspend fun deleteAndReassign(sourceAccountId:String,targetAccountId:String?)=Unit}
