...
class AccountsScreenTest {
 @get:Rule val compose=createComposeRule();private val repository=FakeAccounts()
 @Before fun content(){compose.setContent{BudgetPlusPlusTheme{AccountsScreen(onBack=null,viewModel=AccountsViewModel(repository))}}}
