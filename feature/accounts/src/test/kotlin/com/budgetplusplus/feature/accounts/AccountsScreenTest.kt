...
private class FakeAccounts:AccountRepository{val values=MutableStateFlow<List<Account>>(emptyList());override fun observeAccounts():Flow<List<Account>> =values;override fun observeTotals(id:String)=flowOf(AccountOperationTotals());override fun observeHierarchyMetrics(id:String)=flowOf(AccountHierarchyMetrics());override suspend fun create(name:String,type:AccountType,initialBalanceMinor:Long,currencyCode:String,parentAccountId:String?){values.value=listOf(Account("id",name,type,currencyCode,initialBalanceMinor,initialBalanceMinor))};override suspend fun update(id:String,name:String,type:AccountType,iconKey:String,colorKey:String,description:String,displayOrder:Int)=Unit;override suspend fun move(id:String,parentAccountId:String?)=Unit;override suspend fun setArchived(id:String,archived:Boolean){};override suspend fun reassignOperations(sourceAccountId:String,targetAccountId:String,transactionIds:Set<String>)=Unit;override suspend fun deleteAndReassign(sourceAccountId:String,targetAccountId:String?)=Unit}
