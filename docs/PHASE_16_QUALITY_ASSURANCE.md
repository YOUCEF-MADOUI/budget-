...
`FullMigrationTest` crée un schéma version 1 peuplé, applique successivement `MIGRATION_1_2` à `MIGRATION_10_11`, puis laisse Room valider le schéma 11 complet. Il vérifie notamment sous-catégories, budgets, récurrences et FTS. Les convertisseurs et déclarations de versions restent testés séparément.
