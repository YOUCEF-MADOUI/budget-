...
`FullMigrationTest` crée un schéma version 1 peuplé, applique successivement `MIGRATION_1_2` à `MIGRATION_6_7`, puis laisse Room valider le schéma 7 complet. Il vérifie notamment sous-catégories, budgets, récurrences et FTS. Les convertisseurs et déclarations de versions restent testés séparément.
